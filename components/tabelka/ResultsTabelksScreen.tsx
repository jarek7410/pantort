...
export const ResultsTabelksScreen = ({setPlay,meczId,isOpen}) => {
    /**
     * @var plays - it is list of all done in "turnament"
     * @var setPlays - let u change histy in "turnament"
     *
     */
    ...
    const sortPlaysRender = (open) => {
        ...
        return plays.sort((a,b)=>sorting(a,b))
            .map((play) => {
            if(play.Open===open) {
                if(open===isOpen){
